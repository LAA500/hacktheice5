...
use App\Cart\Validators\CartConditionValidator;
...
class CartCondition
{
    ...
    public function __construct(array $args)
    {
        ...
        if (Helpers::isMultiArray($args)) {
            throw new InvalidConditionException('Многомерный массив не поддерживается.');
        } else {
    ...
    /**
     * Цель, к которой применяется условие.
     * ПРИМЕЧАНИЕ. При добавлении условий к базовым предметам цель не требуется.
     *
     * @return mixed
     */
